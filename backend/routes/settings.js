...
const ALLOWED_SETTINGS_KEYS = new Set([
    ...
    'enable_gst_per_item', 'enable_discount_per_item', 'enable_sku', 'show_category_in_invoice', 'enable_realtime_price_update', 'restrict_realtime_price_sync',
    ...
    'onboarding_completed', 'terminal_type'
]);
