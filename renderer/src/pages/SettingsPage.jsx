                        ...
                        {activeTab === 'profile' && (
                            <div className="settings-section-card">
                                ...
                                <div className="settings-grid">
                                 ...
                                 {/* Stacked Branch Profiles */}
                                 {stores.filter(s => !s.is_hq).map(st => (
                                     <div key={st.id} style={{ marginTop: '24px', paddingTop: '24px', borderTop: '1px dashed #cbd5e1' }}>
                                         <h4 style={{ fontSize: '14px', color: 'var(--accent)', marginBottom: '12px' }}>
                                             🏬 Profile & Contact ({st.name} - Child Branch {st.store_code})
                                         </h4>
                                         <div className="settings-grid">
                                             <div className="form-group">
                                                 <label>Branch Name</label>
                                                 <input value={st.name} readOnly style={{ background: '#f8fafc' }} />
                                             </div>
                                             <div className="form-group">
                                                 <label>GSTIN</label>
                                                 <input value={st.gstin || settings.gstin} readOnly style={{ background: '#f8fafc' }} />
                                             </div>
                                             <div className="form-group">
                                                 <label>Branch Phone</label>
                                                 <input value={st.phone || settings.phone} readOnly style={{ background: '#f8fafc' }} />
                                             </div>
                                             <div className="form-group">
                                                 <label>Branch Email</label>
                                                 <input value={st.email || settings.email} readOnly style={{ background: '#f8fafc' }} />
                                             </div>
                                         </div>
                                     </div>
                                 ))}
                            ...
                            <div className="settings-section-card">
                                ...
                                <div className="changelog-timeline" style={{ display: 'flex', flexDirection: 'column', gap: '24px', position: 'relative', paddingLeft: '24px' }}>
                                    ...
                                    {updateState.status === 'available' && (
                                     ...
                                     {/* Timeline Item: v2.13.0 — Real Supabase Store Handshake & Google Profile Picture */}
                                     <div style={{ position: 'relative' }}>
                                         <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                         <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                             <strong style={{ fontSize: '15px' }}>Version 2.13.0 {updateState.status !== 'available' && '(Latest)'}</strong>
                                             <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>August 1, 2026</span>
                                         </div>
                                         <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                              <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                  <li><strong>Working Switch Account & Supabase Signout</strong>: Fixed profile card logout button to execute real Supabase signout, clear local staff state, and navigate to the Login screen.</li>
                                                  <li><strong>Google Profile Picture & Initials Fallback</strong>: Sidebar footer profile badge dynamically displays Google account profile avatars with automatic fallback to computed initials (GA).</li>
                                                  <li><strong>Role Title & Role-Based Tab Access</strong>: Formatted top profile title to display staff roles (Primary Admin, Store Manager, Cashier) and enforced strict tab locking by role.</li>
                                                  <li><strong>Quantro Brand Header Logo</strong>: Left brand box in top store switcher automatically uses uploaded business logo or official Quantro logo; purged text/icon emojis from All Outlets.</li>
                                                  <li><strong>Supabase Cloud Store Handshake</strong>: Real cloud synchronization and 16-character token verification between Parent HQ and Child Terminals using public.stores and public.store_pairing_tokens.</li>
                                              </ul>
                                         </div>
                                     </div>

                                     {/* Timeline Item: v2.12.0 — Business Onboarding Wizard */}
                                     <div style={{ position: 'relative' }}>
                                         <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                         <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                             <strong style={{ fontSize: '15px' }}>Version 2.12.0</strong>
                                             <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>August 1, 2026</span>
                                         </div>
                                         <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                              <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                  <li><strong>Interactive Business Onboarding Wizard</strong>: 5-step onboarding flow with progress bar for initial store setup immediately after login.</li>
                                                  <li><strong>Parent HQ vs Child Branch Setup</strong>: Choice between setting up a primary HQ business account or connecting to a Parent HQ network via 16-character token.</li>
                                                  <li><strong>Logo Upload & Auto-Population of Settings</strong>: Drag-and-drop Logo Upload with auto-population of all business details into settings.</li>
                                                  <li><strong>Child Branch Disconnect</strong>: Added Disconnect Branch button in Settings to disconnect or remove child branch terminals at any time.</li>
                                              </ul>
                                         </div>
                                     </div>
                                     ...
                                     <div style={{ position: 'relative' }}>
                                         ...
                                         <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                             <strong style={{ fontSize: '15px' }}>Version 2.10.70</strong>
                                         ...
                                         <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                              <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                  <li><strong>Full Stateful Session Recovery</strong>: Comprehensive session auto-save & recovery across all ERP pages (Sales, Inventory, Purchase, Customers, Billing, Automation).</li>
                                                  <li><strong>Quotation Template Real-Time Search</strong>: Added dedicated search bar inside Quotation Templates to filter templates by title or QTN number.</li>
                                     ...
                                     <div style={{ position: 'relative' }}>
                                         ...
                                         <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                              <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                  ...
                                                  <li><strong>Automatic Cart & Template Reset</strong>: Going back to the customer list or changing customers automatically deselects active templates and resets cart items.</li>
                                     ...
                                     <div style={{ position: 'relative' }}>
                                         ...
                                         <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                              <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                  <li><strong>Forced Legacy Credit Clean-Up</strong>: Automatically resets older free seeded wallet balances to zero in SQLite database.</li>
                                                  <li><strong>Low Credit Warning Banners</strong>: Added visual alerts prompting users to top up early when prepaid balance drops.</li>
                                              </ul>
                                         </div>
                                     </div>
                                     ...
                                     <div style={{ position: 'relative' }}>
                                         ...
                                         <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                              <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                  <li><strong>Robust Offline Support</strong>: Implemented fallback custom elements for buttons and modals, preventing white screen crashes when the app runs offline.</li>
                                              </ul>
                                         </div>
                                     </div>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.55</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 24, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        ...
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Fixed Dashboard Chart Mismatch Crashes</strong>: Converted Recharts-style charts in the Dashboard page's Inventory tab (Stock Movement Trend LineChart) and Payment tab (Transactions PieChart and Return & Refund composed chart) to valid MUI X Charts components, preventing application-wide crashes when selecting these tabs.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.53 — Clean QEIWA Connection Experience */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.53</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Clean QEIWA Connection Experience</strong>: Removed the custom branding "OBIWA" option and selection choice popup. Clicking "Get WhatsApp Service" now directly and instantly connects to Quantro QEIWA. Cleaned up Automation tab header action buttons (Sync Now, Create New Agent, Last Synced) and duplicate elements.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.52 — Auto-Detect Expired WhatsApp Tokens */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.52</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Auto-Detect Expired WhatsApp Tokens</strong>: Implemented automatic detection for invalidated or expired Meta access tokens (Code 190). When detected, the application automatically marks the connection status as 'Expired' and prompts the user to reconnect in Settings.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.51 — Fixed Dashboard Analytical Trends */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.51</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Fixed Dashboard Analytical Trends</strong>: Corrected daily sales and purchase spend analytics calculation filters (matching database columns <code>purchase_date</code> and <code>date</code>, and summing <code>grand_total</code> and <code>total</code> correctly). Refactored date range generator to use timezone-safe local calendar dates.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.50 — Direct Prepaid Wallet Validation */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.50</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Prepaid Wallet Balance Validation</strong>: Replaced card payment method config checks with direct wallet credit balance validation. Users with wallet balance above ₹0.30 can now seamlessly send WhatsApp templates.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.49 — Identical Chart Setup & Props */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.49</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Identical Chart Setup &amp; Props:</strong> Standardized all line charts (Customer Distribution, Purchase Spend, Daily Sales Trend) to use identical props and axis styling rules.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.48 — Unified Line Chart Styling */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.48</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Unified Line Chart Styling:</strong> Standardized axis fonts, ticks, lines, and margin alignment across all key line charts (Customer Distribution by Tier, Purchase Spend, and Daily Sales Trend) to match the layout of the Customers tab chart exactly.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.47 — Increased Line Chart Height */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.47</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Expanded Chart Heights:</strong> Increased the layout height of all three key analytical line charts (Customer Distribution by Tier, Purchase Spend, and Daily Sales Trend) to 240px for ideal reading granularity on desktop.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.46 — Taller Line Charts */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.46</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Taller Line Charts for Key Analytics:</strong> Converted Customer Distribution by Tier, Purchase Spend, and Daily Sales Trend from bar/area sparklines to polished Line Charts with increased height (160px) and visible Y-axis values for enhanced analytical clarity.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.45 — Removed Payment Cards */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.45</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Removed Payment Card &amp; Setup Requirements:</strong> Removed all credit card setup requirements, buttons, and warnings since service charges are automatically deducted from the pre-paid wallet credit balance.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.44 — Relocated Top Up Button */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.44</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Relocated &amp; Simplified Top Up Button:</strong> Moved the Top Up Wallet Credit action button directly to the Active Plan (Free Starter) card, removing the wallet icon and external platform tags for a clean, simplified look.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.43 — Compact Stats Spacing */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.43</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Polished Details Spacing:</strong> Added max-width constraints on service rate indicators, card usage metrics, and account summary calculations to prevent layout stretching on full-width displays.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.42 — Full Width Billing Cards */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.42</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Full-Width Billing Summary &amp; Payment Settings Layout:</strong> Converted the entire billing interface into a single full-width continuous stack, stretching Account Summary and Payment Method configurations to 100% width for clean and polished desktop accessibility.</li>
                                             </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.41</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        ...
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Reverted All Charts to Standard Engine:</strong> Reverted all interactive sales, return, and stock analytics charts across all ERP tabs to the default standard charting engines (MUI X-Charts / Recharts) for absolute compatibility and stability.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.39 — Composable Bklit Chart Library */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.39</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Fully Composable Bklit React Chart Engine:</strong> Rebuilt the chart library to use React Context API with modular components (<code style={{ fontFamily: 'monospace' }}>AreaChart</code>, <code style={{ fontFamily: 'monospace' }}>Area</code>, <code style={{ fontFamily: 'monospace' }}>Grid</code>, <code style={{ fontFamily: 'monospace' }}>XAxis</code>, <code style={{ fontFamily: 'monospace' }}>YAxis</code>, <code style={{ fontFamily: 'monospace' }}>ReferenceArea</code>, <code style={{ fontFamily: 'monospace' }}>ChartTooltip</code>). Implemented sliding dark date pills, active Y-axis highlight values, and ease-out hover transitions.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.38 — XAxis Tick Overlap Protection */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.38</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>XAxis Tick Sampling & Centering:</strong> Implemented dynamically spaced absolute-positioned ticks to completely eliminate label overlaps when displaying monthly/yearly intervals.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.37 — Bklit UI Chart Design Overhaul */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.37</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 23, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Bklit UI Chart Rendering Overhaul:</strong> Re-engineered Bklit SVG chart engine with monotone cubic Hermite curves (<code style={{ fontFamily: 'monospace' }}>curveMonotoneX</code>), distortion-free marker rings, vertical crosshair tracking, glassmorphic tooltips, and graceful zero/empty data baseline rendering.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.36 — Navigation Import Fix */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.36</strong>
                                        ...
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Navigation Import Hardening:</strong> Added explicit <code style={{ fontFamily: 'monospace' }}>useNavigate</code> import from <code style={{ fontFamily: 'monospace' }}>react-router-dom</code> in DashboardPage resolving runtime reference error.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.35 — Billing Layout Optimization & Direct Web Top-Up Action */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.35</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 22, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Billing Page Layout Optimization:</strong> Removed chart from Billing Page, expanded service cards to full width utilization, and simplified the header wallet pill.</li>
                                                 <li><strong>Reverted Account Summary Card:</strong> Restored classic Account Summary card with direct <strong>[Top Up Wallet Credit]</strong> web portal redirection action.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.34 — Complete 17 Bklit Chart Library & Full Analytics Upgrade */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.34</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 22, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Bklit 17-Chart Data Visualization Library:</strong> Built native Bklit chart components covering Area, Bar, Candlestick, Choropleth, Composed, Funnel, Gauge, Heatmap, Line, Profit/Loss, Live Line, Pie, Radar, Ring, Scatter, Sankey, and Sunburst charts.</li>
                                                 <li><strong>Full Analytics Migration:</strong> Upgraded Dashboard and Automation Analytics pages to use native Bklit chart components.</li>
                                             </ul>
                                        </div>
                                    </div>

                                    {/* Timeline Item: v2.10.33 — Bklit Time-Series Brush Charts & Shopify Polaris Top-Up Modal */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.33</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 22, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Bklit Time-Series Brush Charts:</strong> Integrated interactive Bklit time-series brush zoom charts (ChartBrushLayout, ChartBrush, AreaChart) into Billing and Workspace Analytics dashboards.</li>
                                                 <li><strong>Shopify Polaris Wallet Modal:</strong> Styled credit top-up modal following Shopify Polaris design standards with Polaris ButtonGroup and Polaris TextField components.</li>
                                             </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.32</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 22, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        ...
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                             <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                 <li><strong>Automations &amp; Google Secrets Console:</strong> Dedicated Automations Hub in Quantro Web with real-time metrics for Voice Calling, WhatsApp Cloud API (QEIWA/OBIWA), and Gmail Delivery via Google OAuth Credentials.</li>
                                                 <li><strong>Per-Workspace Consumption Analytics:</strong> Added Gmail email delivery tracking column and accurate DB &amp; Backup data size measurement in MB/GB.</li>
                                                 <li><strong>System Error Recovery &amp; Diagnostics:</strong> Upgraded global error boundary with instant diagnostic details and single-click recovery.</li>
                                             </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.29</strong>
                                    ...
                                    {/* Timeline Item: v2.10.28 — Unlimited WhatsApp Usage & Connection Button Behavior */}
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.28</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 21, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                            <ul style={{ margin: 0, paddingLeft: '16px' }}>
                                                <li><strong>WhatsApp Connection Button &amp; Usage Limit Behavior:</strong> Removed daily usage limit badge for WhatsApp Service. Configured the "Get WhatsApp Service" header button to automatically disappear when a connection is active and reappear upon disconnection.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '-22px', top: '4px', width: '12px', height: '12px', borderRadius: '50%', background: 'var(--accent)', border: '2px solid var(--bg-primary)' }}></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <strong style={{ fontSize: '15px' }}>Version 2.10.27</strong>
                                            <span style={{ fontSize: '11px', color: 'var(--text-tertiary)', background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '12px' }}>July 21, 2026</span>
                                        </div>
                                        <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: 1.6 }}>
                                            <ul style={{ margin: 0, paddingLeft: '16px' }}>
